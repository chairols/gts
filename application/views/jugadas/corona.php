...
<head>
    ...
    <title>Respuestas Preguntados - Corona</title>
                            ...
                            if($spins->type == 'CROWN') {
                                foreach($spins->questions as $question) {
                                    ...
                                    if($question->question->correct_answer == 3) { ?>
                                        <span class="label label-success"><?=$question->question->answers[3]?></span><br><br>
                                    <?php 
                                    } else { ?>
                                        <span class="label label-danger"><?=$question->question->answers[3]?></span><br><br>
                                    <?php
                                    }
                                    ?>
